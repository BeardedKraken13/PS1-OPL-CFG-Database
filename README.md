...
I hope that one day Apps can integrate support for this rich information, either in OPL Core or as part of tools like OPL Manager. Until then, this database works with OPL 1.1/10th Anniversary Edition and is a starting point for enriched game information on OPL for PS1. 
